...
public class EuclideanDistance extends BaseDTW {
	...
	public EuclideanDistance(String fName, String outDir, int startIndx, int numToProcess) {
		...
		try {
			this.filePath = this.rsltDir + this.fileName + "_" + this.windowSize + "_Euclidean";
...
//			}
	...
	public void execute() {
		// warm up call
		WarpInfo warpInfo = warp.getEuclideanDist(testSet.get(startIndex), trainSet.get(0));
