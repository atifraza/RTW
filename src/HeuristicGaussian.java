...
//		} else
		{
			...
			while(fileNum < args.length) {
				...
				FileWriter fwLengthTime = new FileWriter(rsltDir+args[fileNum]+"_GaussianHeuristic_LengthTimes.csv");
				BufferedWriter bwLengthTime = new BufferedWriter(fwLengthTime);
				FileWriter fwAccuracy = new FileWriter(rsltDir+args[fileNum]+"_GaussianHeuristic_Accuracy.csv");
