...
//		} else
		{
			...
			while(fileNum < args.length) {
				...
				FileWriter fwLengthTime = new FileWriter(resultsDir+args[fileNum]+"_GaussianHeuristic_LengthTimes.csv");
				BufferedWriter bwLengthTime = new BufferedWriter(fwLengthTime);
				FileWriter fwAccuracy = new FileWriter(resultsDir+args[fileNum]+"_GaussianHeuristic_Accuracy.csv");
